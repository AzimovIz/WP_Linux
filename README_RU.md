...
- В `editor` живое GPU-превью построено на том же самом компоузере и тех же
...
| `crates/editor` | Десктопное приложение (egui) для сборки и редактирования проектов обоев, с живым превью. |
...
1. Запустите `editor`, соберите стек слоёв (Image / Gif / Xray / Parallax)
