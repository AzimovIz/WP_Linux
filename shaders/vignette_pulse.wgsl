// A breathing vignette -- unlike the engine's built-in static Vignette
// effect, this one's darkness pulses in and out over time.
...
fn fs_main(in: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let dark = smoothstep(0.3, 0.9, dist) * params.u_intensity * pulse;
    return vec4<f32>(base.rgb * (1.0 - dark), base.a);
}
